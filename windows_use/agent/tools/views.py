...
class Click(SharedBaseModel):
    loc:tuple[int,int]=Field(...,description="The approximate coordinate within the bounding box of the element to click on.",examples=[(0,0)])
...
class Type(SharedBaseModel):
    loc:tuple[int,int]=Field(...,description="The approximate coordinate within the bounding box of the element to type on.",examples=[(0,0)])
...
class Scroll(SharedBaseModel):
    loc:tuple[int,int]|None=Field(description="The approximate coordinate within the bounding box of the element to scroll on. If None, the screen will be scrolled.",default=None,examples=[(0,0)])
